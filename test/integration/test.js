...
describe('coinfs', function() {
  ...
  it('can decode a transaction for bitcoin', function(done) {
    ...
    coinfs.decode(raw, 'testnet', function(err, transaction) {
      assert(transaction.toString() === 'Lost coins only make everyone else’s coins worth slightly more. Think of it as a donation to everyone.')
      done()
    })
  })
})